...
def automate_easemytrip():
    with sync_playwright() as p:
        ...
        # Select Source City - Delhi — use press_sequentially to trigger autocomplete
        ...
        try:
            ...
            print("   [OK] Boarding Point selected!")
            time.sleep(3)
            boarding.click(force=True)
            print("   [OK] Boarding Point deselected!")
            time.sleep(3)
        ...
        try:
            ...
            print("   [OK] Dropping Point selected!")
            time.sleep(3)
        except Exception as e:
            print(f"   [WARN] Error: {e}")
        ...
        try:
            ...
            print("   [OK] Boarding & Dropping Point tab clicked!")
            time.sleep(3)
        except Exception as e:
            print(f"   [WARN] Error: {e}")
