...
def automate_easemytrip():
    with sync_playwright() as p:
        ...
        try:
            ...
            continue_button = new_page.locator('//form//button[contains(text(), "Continue") or contains(text(), "continue")]')
            ...
            try:
                cancel_button = new_page.locator('//div[@id="otpPin"]//div[contains(@class, "button") or @role="button"]//button | //div[@id="otpPin"]//button[2] | //button[contains(text(), "Cancel") or contains(text(), "Back")]').last
