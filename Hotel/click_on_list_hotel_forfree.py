...
def automate_easemytrip():
    with sync_playwright() as p:
        ...
        try:
            ...
            # Click on list hotel for free
            print("🏨 Clicking on list hotel for free...")
            hotel_choice = page.locator('xpath=/html/body/div[3]/div/a')
            hotel_choice.click()
            print("✅ List hotel for free clicked!")
