...
def automate_easemytrip():
    with sync_playwright() as p:
        ...
        try:
            ...
            # Click on hotel of popular destination
            print("🏨 Clicking on hotel of popular destination...")
            hotel_popular = page.locator('xpath=/html/body/div[10]/div/div[2]/div[1]/div[2]/h5/a')
            hotel_popular.click()
            print("✅ Hotel of popular destination clicked!")
