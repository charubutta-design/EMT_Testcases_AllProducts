...
def automate_easemytrip():
    with sync_playwright() as p:
        ...
        print("\n[SEARCH] === APPLYING GPS ENABLED FILTER ===\n")
        time.sleep(2)
        ...
        try:
            ...
            for selector in gps_selectors:
                try:
                    ...
                    if elem.is_visible(timeout=3000):
                        ...
                        print("   [OK] GPS Enabled filter applied!")
                        gps_elem = elem
                        filter_applied = True
                        time.sleep(3)
                        break
            ...
            if not filter_applied:
                print("   [WARN] GPS Enabled filter not found")
        ...
        print("\n[TARGET] === CLICKING AMENITIES LISTING ===\n")
        time.sleep(2)
        ...
        try:
            ...
            for selector in amenities_selectors:
                try:
                    ...
                    if elem.is_visible(timeout=3000):
                        elem.click(force=True)
                        print("   [OK] Amenities listing clicked!")
            ...
            if not amenities_clicked:
                print("   [WARN] Amenities option not found")
        except Exception as e:
            print(f"   [WARN] Error: {e}")
