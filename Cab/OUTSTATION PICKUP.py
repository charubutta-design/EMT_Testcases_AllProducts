...
def launch_easemytrip():
    with sync_playwright() as p:
        ...
        # Click on source input field (class: nwgry overflw_txt ftn22 srcShow, id: sourceName)
        print("Clicking on source name input field...")
        source_name = page.locator('#sourceName.nwgry.overflw_txt.ftn22.srcShow')
        source_name.wait_for(state="visible", timeout=10000)
        source_name.click()
        print("Clicked on sourceName field.")
        page.screenshot(path="easemytrip_source_name.png")
        print("Screenshot saved as easemytrip_source_name.png")
