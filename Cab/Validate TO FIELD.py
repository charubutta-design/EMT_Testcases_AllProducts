...
def launch_easemytrip():
    with sync_playwright() as p:
        ...
        print("Clicking on destination field...")
        destination = page.locator('#destinationName')
        destination.wait_for(state="visible", timeout=10000)
        destination.click()
        print("Clicked on destinationName field.")
        page.screenshot(path="easemytrip_cab_destination.png")
        print("Screenshot saved as easemytrip_cab_destination.png")
