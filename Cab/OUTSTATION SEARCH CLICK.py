...
def launch_easemytrip():
    with sync_playwright() as p:
        ...
        # Click on Outstation
        print("Clicking on Outstation...")
        outstation = page.locator("[onclick=\"GetNewCabSection('2')\"]")
        outstation.wait_for(state="visible", timeout=10000)
        outstation.click()
        page.wait_for_load_state("domcontentloaded")
        ...
        # Click on Search button (class="srch-btn-c")
        print("Clicking on Search button...")
        search_btn = page.locator("#CommonSearch .srch-btn-c")
        ...
        page.screenshot(path="easemytrip_search_result.png")
        print("Screenshot saved as easemytrip_search_result.png")
